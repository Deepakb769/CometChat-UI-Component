...
const COMETCHAT_CONSTANTS = {
  APP_ID: "2734497b42010522", // Replace with your actual App ID from CometChat
  REGION: "in", // Replace with your App's Region
  AUTH_KEY: "1b59efa30658933406a43d0bef45316d9dbd79bd", // Replace with your Auth Key (leave blank if using Auth Token)
};
